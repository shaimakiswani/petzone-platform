  ...
  return (
    <div className="flex flex-col gap-16 pb-16">
      ...
      <section className="relative pt-12 pb-20 lg:pt-20 lg:pb-28 overflow-hidden rounded-3xl bg-brand-100/50 mt-4 px-6 text-center shadow-sm">
        <div className="max-w-3xl mx-auto relative z-10">
          ...
          <p className="text-lg lg:text-xl text-gray-600 mb-10 max-w-2xl mx-auto">
            PetZone connects you with adoptable pets, top-tier clinics, and the best supplies in your area. Every pet deserves a loving home.
          </p>
      ...
      <section className="grid md:grid-cols-3 gap-8">
        {[
          { icon: Heart, title: "Adoptions", desc: "Browse hundreds of vetted pets waiting for a home." },
          { icon: Shield, title: "Verified Clinics", desc: "Connect with certified veterinarians." },
          { icon: Search, title: "Lost & Found", desc: "Report missing pets or help others find theirs." }
        ].map((feature, i) => (
