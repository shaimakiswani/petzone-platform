  ...
  return (
    <div className="max-w-2xl mx-auto py-8">
      ...
      <form onSubmit={handleSubmit} className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 space-y-6">
        ...
        <div>
          <label className="block text-sm font-bold text-gray-900 mb-4">Hostel Media Assets</label>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-brand-50/50 p-5 rounded-3xl border-2 border-dashed border-brand-200 hover:border-brand-400 transition group relative">
              ...
              />
              <p className="text-[10px] text-gray-400 mt-2">The main profile photo for your hostel.</p>
              {formData.image && (
            ...
            <div className="bg-slate-50 p-5 rounded-3xl border-2 border-dashed border-slate-200 hover:border-slate-400 transition group relative">
              <label className="block text-xs font-black text-slate-500 uppercase mb-3 tracking-widest">2. Service Gallery (Max 5)</label>
              <input 
                type="file" 
                multiple
                accept="image/*" 
              ...
              />
              <p className="text-[10px] text-gray-400 mt-2">Show the rooms, play areas, and happy guests!</p>
