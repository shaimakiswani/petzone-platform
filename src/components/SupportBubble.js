...
export default function SupportBubble() {
  ...
  return (
    <div className={`fixed bottom-10 left-6 md:left-10 z-50`}>
      {/* Support Window */}
      {isOpen && (
        <div className={`absolute bottom-0 left-0 w-80 sm:w-96 bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden transition-all animate-in slide-in-from-bottom-5 duration-300 flex flex-col h-[500px]`}>
