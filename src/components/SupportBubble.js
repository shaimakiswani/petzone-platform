...
export default function SupportBubble() {
  ...
  return (
    <div className={`fixed bottom-8 ${isAr ? 'left-8' : 'right-8'} z-50`}>
      {/* Support Window */}
      {isOpen && (
        <div className={`absolute bottom-20 ${isAr ? 'left-0' : 'right-0'} w-80 bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden transition-all animate-in slide-in-from-bottom-5 duration-300`}>
